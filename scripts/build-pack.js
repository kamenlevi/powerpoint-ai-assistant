 ...
 *
 * This is intentionally a manual maintainer flow, not something end users run.
 * End users just download the pre-built tarball via the Settings UI, which
 * pulls each image from the URLs in the committed manifest.
 *
 * After running, commit the updated manifest.json. Optionally bundle the
 * downloaded images as pack-vN.tar.gz and upload to GitHub Releases.
 */
